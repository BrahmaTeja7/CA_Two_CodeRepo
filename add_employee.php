...
$name = $_POST["emp_name"];
$epf_no = $_POST["employeeno"];
$branch = $_POST["branch"];
$category = $_POST["category"];
$department = $_POST["department"];
$designation = $_POST["designation"];
$email = $_POST["email"];
$systemlogin = $_POST["scilogin"];
...
$sql = "INSERT INTO employee (emp_code, name, epf_no, branch_code, category_code, department_code, designation_code, system_login, pc_login, internet, email, mobile, form_no, status, created_by, created_date) VALUES (NULL, '$name', '$epf_no', '$branch', '$category', '$department', '$designation', '$systemlogin','$pclogin', '$internet', '$email', '$mobile', '$form_no', '$status', '1', '2023-04-22')";
